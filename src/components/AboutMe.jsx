            ...
            <section id="about" className={`flex md:flex-row flex-col ${styles.paddingY} lg:mt-20 mt-20`}>
              <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                <div className="flex flex-row justify-between items-center w-full">
                  <h1 className="flex-1 font-poppins font-medium uppercase ss:text-[32px] text-[20px] text-white ss:leading-[50px] leading-[30px]">
                    Hi, I'm<br/>
                    <span className="text-secondary ss:text-[40px] text-[26px] font-black">Sagar Ghimire</span> {" "}
                    <br />UI/UX Designer.
                  </h1>
                </div>
                <p className={`${styles.paragraph} max-w-[650px] mt-5`}>During the last 2+ years as a design professional, I’ve been working with companies from various industries, helping them to build new services from the ground up, but also improve existing ones.
              ...
              <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative lg:mr-16`}>
                <img  src={Myprofile} alt="website" className="lg:w-[100%] lg:h-[100%] w-[60%] h-[60%] relative z-[5]" />
              </div>
            </section>
